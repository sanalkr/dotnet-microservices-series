...
namespace CatalogAPI.Data
{
    public class CatalogContextSeed
    {
        ...
        private AsyncRetryPolicy CreatePolicy(ILogger<CatalogContextSeed> logger)
        {
            int retries = 3;
            return Policy.Handle<SqlException>().
                WaitAndRetryAsync(
                        ...
                        {
                            logger.LogWarning(exception, "CatalogSeed: Exception {exceptionType} with message {Message} occured on attempt {retry} of {retires}",
