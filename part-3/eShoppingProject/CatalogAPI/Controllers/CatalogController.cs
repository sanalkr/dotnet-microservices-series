...
namespace CatalogAPI.Controllers
{
    ...
    {   
        ...
        private readonly CatalogIntegrationEventService _integrationEventService;

        public CatalogController(ILogger<CatalogController> logger,
            CatalogContext context,
            CatalogIntegrationEventService integrationEventService)
        {
            _logger = logger;
            _context = context;
        ...
        public async Task<ActionResult> UpdateProductAsync([FromBody] CatalogItem productToUpdate)
        {
            ...
            if (raiseProductPriceChangedEvent)
            {
                ...
                await _integrationEventService.PublishThroughEventBusAsync(priceChangedEvent);
            }
